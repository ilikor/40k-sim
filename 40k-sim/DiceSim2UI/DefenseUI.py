...
class DefenseUI(tk.Frame):
    ...
    def defenseLabel(self):
        ...
        self.Text_Max_Model = tk.StringVar()
        self.Text_Max_Model.set("Unit size")
        self.Label_Max_Model = tk.Label(self, textvariable=self.Text_Max_Model, width = width_text)
        self.Label_Max_Model.grid(row = 10, column = 0)
         
         
        self.Text_FnP = tk.StringVar()
        self.Text_FnP.set("FnP")
        self.Label_FnP = tk.Label(self, textvariable=self.Text_FnP, width=width_text)
        self.Label_FnP.grid(row = 11, column = 0)
    ...
    def defenseEntry(self):
        ...
        self.Entry_Moral_Rule.config(height = 6, width=width_text)
        ...
        self.Text_Entry_Max_Model = tk.StringVar()
        self.Text_Entry_Max_Model.set("10")
        self.Entry_Max_Model = tk.Entry(self, textvariable=self.Text_Entry_Max_Model, width=width_text)
        self.Entry_Max_Model.grid(row = 10, column = 1)
    ...
    def gather_Input(self):
        try:
            ...
            for FnP in self.FnP_List:
                ...
                FnPInput.append(nextFnP)
            
            us = self.clean_input(self.Entry_Max_Model.get())  
            
            D = Defense.Defense(T,W,Sv,ISv, FnPInput, moral, pts )
