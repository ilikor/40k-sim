...
class AtkInput():
    ...
    def populate_Rules_Listbox(self):
        ...
        hit_rules_names_list = SpecialRules.SpecialRule.SpecialRule.build_hit_rule_list()
        ...
        wnd_rules_names_list = SpecialRules.SpecialRule.SpecialRule.build_wnd_rule_list()
